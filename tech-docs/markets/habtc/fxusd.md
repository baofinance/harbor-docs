...
Proxy keys and **CREATE3 salt strings**: [Generic → BTC/fxUSD](../generic.md#btcfxusd). Authoritative file: [`deployments/mainnet/harbor_v1.state.json`](https://github.com/baofinance/harbor/blob/main/deployments/mainnet/harbor_v1.state.json).
...
| **peggedTokenZap** | — | `0x7DEAeA986944C8d742668C95fb6fABdE0c7Ca079` (MinterUSDCZap_v1) |
| **leveragedTokenZap** | — | `0x7DEAeA986944C8d742668C95fb6fABdE0c7Ca079` (MinterUSDCZap_v1) |
...
| Pegged / leveraged (minter) | MinterUSDCZap_v1 | `0x7DEAeA986944C8d742668C95fb6fABdE0c7Ca079` |
...
| Field | Value |
| ----- | ----- |
| **Start** | December 19, 2025 (`2025-12-19T21:38:23Z`) |
