...
### Mainnet proxy tables

Proxies are split **per market** (use the on-this-page links). Each table scrolls horizontally if needed.

#### BTC/fxUSD

<div class="table-scroll table-proxy">
