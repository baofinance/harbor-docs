...
## Pool and yield wrappers (Level 1 live; 2–3 not production)

| Token | Role | Interface | Status |
| ----- | ---- | --------- | ------ |
| **hpXXX.COLn** | Rebasing stability-pool share (v3 design) | Live v1/v2 pools use compounding balances; v3 adds ERC-20 shares | Live pools: see [Stability pool](../contracts/stability-pool.md) |
